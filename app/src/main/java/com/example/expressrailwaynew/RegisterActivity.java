...
//
//
//            hospitalDatabaseHelper = new DbHandler(getApplicationContext());
//            db = hospitalDatabaseHelper.getWritableDatabase();
//
//            cursor = DbHandler.selectAccount(db, HelperUtilities.filter(inputEmail.getText().toString()));
//
